...
interface MentorCardProps {
  ...
  tags: MentorTagDto[];
  /** When provided the card renders as a button that triggers the callback instead of navigating. */
...
const MentorCard: React.FC<MentorCardProps> = ({ card, tags, onClick }) => {
  ...
  if (onClick) {
    return (
      <button
        type="button"
        className="group block w-full text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 rounded-2xl"
